...
bool Loading::TryLoadByJNI(JNIEnv *env, jobject context) {
    ...
    if (context == nullptr) {
        ...
        auto currentMethod =
            env->GetStaticMethodID(activityThread, BNM_OBFUSCATE_TMP("currentActivityThread"),
    ...
    auto getApplicationInfo =
        contextClass ? env->GetMethodID(contextClass, BNM_OBFUSCATE_TMP("getApplicationInfo"),
    ...
    auto flagsField =
        env->GetFieldID(applicationInfoClass, BNM_OBFUSCATE_TMP("flags"), BNM_OBFUSCATE_TMP("I"));
    ...
    auto dirField = env->GetFieldID(applicationInfoClass,
    ...
    std::string file =
        std::string(cDir) + (isLibrariesExtracted
    ...
    if (handle) {
        ...
        BNM_LOG_ERR("TryLoadByJNI dlopen failed for %s", file.c_str());

    if (!result && !isLibrariesExtracted) {
        file =
            std::string(splitBase) + BNM_OBFUSCATE_TMP("split_config." CURRENT_ARCH
        ...
        if (handle) {
            ...
            BNM_LOG_ERR("TryLoadByJNI split dlopen failed for %s", file.c_str());
    }
...
bool Loading::TryLoadByDlfcnHandle(void *handle) { return CheckHandle(handle); }
...
bool Loading::TryLoadByUsersFinder() {
    auto init = Internal::currentFinderMethod(BNM_OBFUSCATE_TMP("il2cpp_init"),
    ...
    if (Internal::states.lateInitAllowed)
        Internal::LateInit(Internal::currentFinderMethod(
            BNM_OBFUSCATE_TMP("il2cpp_class_from_il2cpp_type"), Internal::currentFinderData));
...
void Internal::LateInit(void *il2cpp_class_from_il2cpp_type_addr) {
    ...
    BNM_Class$$FromIl2CppType_origin = ::BasicHook(
        from_il2cpp_type, (void *) BNM_Class$$FromIl2CppType, old_BNM_Class$$FromIl2CppType);
}
...
bool Internal::SetupBNM() {
    ...
    if (api.il2cpp_array_new_specific) {
        ...
        if (init) {
            ...
            BNM_LOG_WARN("Class::Init not resolved");
    }

    if (api.il2cpp_class_from_type) {
        auto from_type_adr = FindJump((void *) api.il2cpp_class_from_type, count);
        if (from_type_adr) {
            ::BasicHook(from_type_adr, (void *) ClassesManagement::Class$$FromIl2CppType,
    ...
    if (api.il2cpp_type_get_class_or_element_class) {
        auto type_get_class_adr =
            FindJump((void *) api.il2cpp_type_get_class_or_element_class, count);
        if (type_get_class_adr) {
            ::BasicHook(type_get_class_adr,
                        (void *) ClassesManagement::Type$$GetClassOrElementClass,
                        ClassesManagement::old_Type$$GetClassOrElementClass);
            BNM_LOG_DEBUG("vm::Type::GetClassOrElementClass hooked at %p",
                          OffsetInLib(type_get_class_adr));
        }
    }
    ...
    if (api.il2cpp_class_from_name) {
        ...
        if (from_name_adr) {
            ::BasicHook(from_name_adr, (void *) ClassesManagement::Class$$FromName,
    ...
    if (api.il2cpp_image_get_types) {
        ...
        if (get_types_adr) {
            ::BasicHook(get_types_adr, (void *) Internal::Image$$GetTypes,
                        Internal::orig_Image$$GetTypes);
    ...
    auto runtimeMethodInfoClass =
        TryGetClassInImage(corlib, "System.Reflection", "RuntimeMethodInfo");
    if (runtimeMethodInfoClass) {
        vmData.RuntimeMethodInfo$$MakeGenericMethod_impl = MethodBase(
            IterateMethods(Class(runtimeMethodInfoClass), [](IL2CPP::MethodInfo *method) {
    ...
    if (!vmData.RuntimeMethodInfo$$MakeGenericMethod_impl.IsValid())
        vmData.RuntimeMethodInfo$$MakeGenericMethod_impl =
            Class("System.Reflection", "MonoMethod", corlib).GetMethod("MakeGenericMethod_impl");
    ...
    vmData.Interlocked$$CompareExchange =
        interlockedClass.GetMethod("CompareExchange", {objectClass, objectClass, objectClass});
    auto stringEmpty = stringClass.GetField("Empty");
    if (stringEmpty)
        vmData.String$$Empty = (IL2CPP::Il2CppString **) stringEmpty.GetFieldPointer();
    ...
    if (listClass) {
        ...
        auto size =
            sizeof(IL2CPP::Il2CppClass) + cls->vtable_count * sizeof(IL2CPP::VirtualInvokeData);
        auto newListClass = (IL2CPP::Il2CppClass *) BNM_malloc(size);
        memcpy(newListClass, cls, size);
        newListClass->has_finalize = 0;
        newListClass->instance_size = newListClass->actualSize =
            sizeof(Structures::Mono::List<void *>);
        ...
        if (ctor && newListClass->methods && newListClass->method_count) {
            ...
            auto newMethods = (IL2CPP::MethodInfo **) BNM_malloc(sizeof(IL2CPP::MethodInfo *) *
                                                                 newListClass->method_count);
            memcpy(newMethods, newListClass->methods,
                   sizeof(IL2CPP::MethodInfo *) * newListClass->method_count);
            ...
            *newConstructor = *constructor;
            ...
            newConstructor->virtualMethodPointer =
                (decltype(newConstructor->virtualMethodPointer)) EmptyMethod;
            ...
            for (uint16_t i = 0; i < newListClass->method_count; ++i) {
                if (newListClass->methods[i] == constructor)
...
IL2CPP::Il2CppClass *Internal::BNM_Class$$FromIl2CppType(IL2CPP::Il2CppReflectionType *type) {
    ...
    if (!api.il2cpp_domain_get) {
        api.il2cpp_domain_get = (decltype(api.il2cpp_domain_get)) GetIl2CppMethod(
            BNM_OBFUSCATE_TMP("il2cpp_domain_get"));
        api.il2cpp_thread_current = (decltype(api.il2cpp_thread_current)) GetIl2CppMethod(
            BNM_OBFUSCATE_TMP("il2cpp_thread_current"));
    }

    if (!api.il2cpp_domain_get || !api.il2cpp_thread_current)
        return klass;

    auto domain = api.il2cpp_domain_get();
    auto thread = api.il2cpp_thread_current();

    if (!domain || !thread || !thread->internal_thread ||
        (void *) domain->default_context != (void *) thread->internal_thread->current_appcontext)
        return klass;
    ...
    try {
        ...
        BNM_LOG_ERR("BNM_Class$$FromIl2CppType Load exception: %s",
                    Internal::GetExceptionTypeName());
    }
...
void Internal::Load() {
    ...
    if (loadStarted.test_and_set(std::memory_order_acq_rel))
        return;
...
IL2CPP::Il2CppImage *Internal::TryGetImage(const std::string_view &_name) {
    ...
    for (auto assembly : assemblies) {
        ...
        if (!CompareImageName(currentImage, _name))
            continue;
        return currentImage;
    }
...
IL2CPP::Il2CppClass *Internal::TryGetClassInImage(const IL2CPP::Il2CppImage *image,
    ...
    if (api.il2cpp_image_get_class_count && api.il2cpp_image_get_class) {
        ...
        for (size_t i = 0; i < typeCount; ++i) {
            ...
            if (declaring)
                continue;
            if ((!api.il2cpp_class_get_flags(cls) || (name && strcmp(name, "<Module>") == 0)))
                continue;
            auto ns = api.il2cpp_class_get_namespace(cls);
            if (_namespace == (ns ? ns : "") && _name == (name ? name : ""))
                return cls;
        }
    }
...
NEW_CLASSES: {
    ...
    ClassesManagement::ForEachClassInImage(
        (IL2CPP::Il2CppImage *) image,
        [&_namespace, &_name, &result](IL2CPP::Il2CppClass *cls) -> bool {
            auto ns = api.il2cpp_class_get_namespace(cls);
            auto name = api.il2cpp_class_get_name(cls);
            if (_namespace != (ns ? ns : "") || _name != (name ? name : ""))
                return false;
...
Class Internal::TryMakeGenericClass(Class genericType,
                                    const std::vector<CompileTimeClass> &templateTypes) {
    if (!vmData.RuntimeType$$MakeGenericType.IsValid() || !genericType)
        return {};
    ...
    for (IL2CPP::il2cpp_array_size_t i = 0; i < (IL2CPP::il2cpp_array_size_t) templateTypes.size();
         ++i)
    ...
    Class typedGenericType = ((MakeGenericTypeFn) vmData.RuntimeType$$MakeGenericType.GetOffset())(
        monoType, monoGenericsList);

    return typedGenericType;
}

MethodBase Internal::TryMakeGenericMethod(const MethodBase &genericMethod,
                                          const std::vector<CompileTimeClass> &templateTypes) {
    if (!vmData.RuntimeMethodInfo$$MakeGenericMethod_impl.IsValid() || !genericMethod.GetInfo() ||
    ...
    reflectionMethod.object.klass =
        vmData.RuntimeMethodInfo$$MakeGenericMethod_impl.GetParentClass()._data;

    using MakeGenericMethodFn =
        IL2CPP::Il2CppReflectionMethod *(*) (IL2CPP::Il2CppReflectionMethod *,
                                             Structures::Mono::Array<MonoType *> *);
    auto typedGenericMethod =
        ((MakeGenericMethodFn) vmData.RuntimeMethodInfo$$MakeGenericMethod_impl.GetOffset())(
            &reflectionMethod, monoGenericsList);

    return typedGenericMethod ? MethodBase(typedGenericMethod->method) : MethodBase{};
}

Class Internal::GetPointer(Class target) {
    if (!vmData.RuntimeType$$MakePointerType.IsValid() || !target)
        return {};
...
Class Internal::GetReference(Class target) {
    if (!vmData.RuntimeType$$make_byref_type.IsValid() || !target)
        return {};
    auto monoType = target.GetMonoType();
    if (!monoType)
        return {};
