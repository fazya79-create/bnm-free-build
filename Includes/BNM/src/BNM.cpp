...
void *BNM::GetExternMethod(const std::string_view &str) {
    if (!Internal::api.il2cpp_resolve_icall)
        return nullptr;
    std::string name(str);
...
template <>
bool BNM::IsA<BNM::IL2CPP::Il2CppObject *>(BNM::IL2CPP::Il2CppObject *object,
                                           BNM::IL2CPP::Il2CppClass *_class) {
    if (!object || !_class)
        return false;
...
bool BNM::AttachIl2Cpp() {
    if (!Internal::api.il2cpp_thread_attach || !Internal::api.il2cpp_domain_get)
        return false;
    if (CurrentIl2CppThread())
        return false;
...
IL2CPP::Il2CppThread *BNM::CurrentIl2CppThread() {
    if (!Internal::api.il2cpp_thread_current)
        return nullptr;
    return Internal::api.il2cpp_thread_current();
}

void BNM::DetachIl2Cpp() {
    if (!Internal::api.il2cpp_thread_detach)
        return;
...
void *BNM::Allocate(size_t size) {
    if (!Internal::api.il2cpp_gc_alloc_fixed)
        return nullptr;
    return Internal::api.il2cpp_gc_alloc_fixed(size);
}

void BNM::Free(void *ptr) {
    if (!ptr || !Internal::api.il2cpp_gc_free_fixed)
        return;
