...
namespace BNM {
    ...
    template <typename T>
    inline T UnmarshalUnityObject(BNM_INT_PTR ptr) {
        return (T) ptr;
    }
    ...
    struct Class {
        ...
        MethodBase GetMethod(const std::string_view &name,
        ...
        inline void TryInit() const {
            if (_data && Internal::classInitFunc)
                Internal::classInitFunc(_data);
        }

        static IL2CPP::Il2CppObject *BoxObject(IL2CPP::Il2CppClass *_data, void *data);
        static IL2CPP::Il2CppArray *ArrayNew(IL2CPP::Il2CppClass *cls,
    ...
    bool IsA(T object, IL2CPP::Il2CppClass *_class) {
        return IsA<BNM::IL2CPP::Il2CppObject *>((IL2CPP::Il2CppObject *) object, _class);
    }
