...
namespace BNM {
    namespace Exceptions {
        struct Exception {
            ...
            [[nodiscard]] inline std::string ClassName() const {
                return exception && exception->className
                           ? ((Structures::Mono::String *) exception->className)->str()
                           : std::string{};
            }
            [[nodiscard]] inline std::string Message() const {
                return exception && exception->message
                           ? ((Structures::Mono::String *) exception->message)->str()
                           : std::string{};
            }
            [[nodiscard]] inline IL2CPP::Il2CppObject *Data() const {
                return exception ? exception->_data : nullptr;
            }
    ...
    namespace Defaults {
        ...
        namespace Internal {
            extern BNM::Class Void, Boolean, Byte, SByte, Int16, UInt16, Int32, UInt32, IntPtr,
                UIntPtr, Int64, UInt64, Single, Double, Decimal, String, Object, Type;
            extern BNM::Class Vector2, Vector3, Vector4, Color, Color32, Ray, Quaternion, Matrix3x3,
                Matrix4x4, RaycastHit, RaycastHit2D;
        ...
        inline DefaultTypeRef Get() {
            ...
            else if constexpr (std::is_same_v<T, Structures::Mono::String *>)
                return {&Internal::String};
            else if constexpr (std::is_same_v<T, MonoType *>)
                return {&Internal::Type};
            else if constexpr (std::is_same_v<T, IL2CPP::Il2CppObject *>)
                return {&Internal::Object};
            else if constexpr (std::is_same_v<T, Structures::Unity::Vector2>)
                return {&Internal::Vector2};
            else if constexpr (std::is_same_v<T, Structures::Unity::Vector3>)
                return {&Internal::Vector3};
            else if constexpr (std::is_same_v<T, Structures::Unity::Vector4>)
                return {&Internal::Vector4};
            else if constexpr (std::is_same_v<T, Structures::Unity::Color>)
                return {&Internal::Color};
            else if constexpr (std::is_same_v<T, Structures::Unity::Color32>)
                return {&Internal::Color32};
            else if constexpr (std::is_same_v<T, Structures::Unity::Ray>)
                return {&Internal::Ray};
            else if constexpr (std::is_same_v<T, Structures::Unity::Quaternion>)
                return {&Internal::Quaternion};
            else if constexpr (std::is_same_v<T, Structures::Unity::Matrix3x3>)
                return {&Internal::Matrix3x3};
            else if constexpr (std::is_same_v<T, Structures::Unity::Matrix4x4>)
                return {&Internal::Matrix4x4};
            else if constexpr (std::is_same_v<T, Structures::Unity::RaycastHit>)
                return {&Internal::RaycastHit};
            else if constexpr (std::is_same_v<T, Structures::Unity::RaycastHit2D>)
                return {&Internal::RaycastHit2D};
            else if constexpr (std::is_same_v<T, IL2CPP::Il2CppArray *>)
                return {&Internal::Object};
            else
                return {&Internal::Object};
        }
