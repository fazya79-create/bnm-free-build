...
namespace BNM {
    struct FieldBase {
        ...
        inline BNM_PTR GetOffset() const {
            return _data ? (BNM_PTR) _data->offset - (_isInStruct && !_isStatic && !_isThreadStatic
    ...
    struct Field : public FieldBase {
        ...
        inline T *GetPointer() const {
            ...
            BNM_LOG_ERR_IF(ptr == nullptr, "Field::GetPointer dead: %s",
                           _data ? str().c_str() : "null");
            return (T *) ptr;
        }
        ...
        inline Field<T> &operator=(const FieldBase &other) {
            _data = other._data;
